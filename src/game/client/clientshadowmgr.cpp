...
void CClientShadowMgr::InitRenderTargets()
{
	...
	if ( m_DepthTextureCache.Count() )
	{
		...
		//more projectedtextures? (i could already have more then 1, soooo idk)
		//int nNumShadows = 3; MAX_DEPTH_TEXTURE_SHADOWS;
		//m_nLowResStart = 3; MAX_DEPTH_TEXTURE_HIGHRES_SHADOWS;
